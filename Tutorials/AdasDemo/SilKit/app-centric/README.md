...
>**ℹ️ Hint**  
> Since the applications still have some dependencies on MSRA, they require some configuration
> files. It is important to change the directory to the base of the installed application (e.g.
> `./build/Release/install/opt/adas_demo_app`) before running the executable.
